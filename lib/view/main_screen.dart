...
import 'package:segue/view_model/main_view_model.dart';
...
class _MainScreenState extends ConsumerState<MainScreen> {
  ...
  void _onSheetSizeChanged() {
    ...
    ref
        ...
        .setExpanded(_controller.size > 0.5);
  }
  ...
  Widget build(BuildContext context) {
    ...
    final canPop = ref.watch(mainViewModelProvider);

    return PopScope(
      canPop: canPop,
      onPopInvokedWithResult: (didPop, _) {
        if (!didPop) {
          ref.read(mainViewModelProvider.notifier).handleBack();
        }
      },
      child: Scaffold(
